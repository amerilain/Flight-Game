...
print("your ship has crash landed but you must still complete your mission. You must now travel by plane to any ")
print("airport of your choice by using the ICAO code of that airport which you will have the opportunity to look up. ")
print("")
print("Your mission is to record five of the following eight weather conditions:")
